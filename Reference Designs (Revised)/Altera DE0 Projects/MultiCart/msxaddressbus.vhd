...
entity msxaddressbus is
    Port ( CLOCK_50     : in STD_LOGIC;
           ...
           address_ready: out STD_LOGIC -- New output signal
           );
end msxaddressbus;
...
begin
    ...
    -- Output Logic and Address Ready Signal
    ...
    begin
        ...
        address_ready <= '0'; -- Default to '0' when address is not ready
        ...
        -- Assert the address_ready signal once the full address is read
        if current_state = READ_HIGH then
            address_ready <= '1'; -- Address is fully read after READ_HIGH
        end if;
    end process;
